      ...
      >
        <p onMouseEnter={()=>{setIsHovered(true)}} onMouseLeave={()=>{setIsHovered(false)}}
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <button className="px-6 py-3 rounded-full bg-orange-400 text-white text-xl mt-8 text-nowrap flex items-center justify-center gap-5 hover:bg-white hover:text-orange-400 hover:scale-105 transition-transform duration-1000">
              Start today
            </button>
